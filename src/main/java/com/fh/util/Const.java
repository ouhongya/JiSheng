...
public class Const {
    ...
    public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(unitsecondlistName)|(queryCheckReportUser)|(unitlistsearch)|(recordrecyclebin)|(queryWorkload)|(exportTaskIssueList)|(downloaddatabase)|(deleterecyclebin)|(recyclebin)|(unitlist)|(deleteIMEI)|(downunitExcel)|(editunitsecond)|(editU)|(deleterole)|(deleteunit)|(unitsecondlist)|(saverole)|(saveunit)|(seeroleuser)|(saveunitsecond)|(editunit)|(goaddroledata)|(editroledata)|(editrole)|(readunitExcel)|(roleandrolemenu)|(goEditU)|(getSmsCaptcha)|(saveU)|(goAddU)|(listUsers)|(excel)|(deleteU)|(downExcel)|(readExcel)|(code)|(app)|(weixin)|(static)|(main)|(uploadExcel)|(queryExcelList)|(allot)|(queryAllot)|(updateAllot)|(disableExcel)|(rename)|(queryExcelOneAndTwo)|(queryUserPending)|(queryUserPending)|(reject)|(queryUserByBulletin)|(queryUserByBulletinNum)|(queryBulletin)|(createdTask)|(queryTaskToOne)|(editTask)|(deleteTask)|(checkingTaskList)|(checkingTask)|(cancelCheckingTask)|(IssueCheckingTask)|(cancelIssueCheckingTask)|(escalationTask)|(uploadImage)|(deleteImage)|(readByBulletin)|(queryTaskList)|(queryUserProcessed)|(pass)|(enableExcel)|(deleteExcel)|(addBulletin)|(queryReportMessage)|(deleteBulletin)|(questionsList)|(downloadTemplate)|(queryUserBySpecialty)|(queryUnitAll)|(queryExcelOneAndTwo)|(queryTaskIssueList)|(querySiteAll)|(checkingTaskList)|(queryUserByTask)|(queryUserByTaskToUser)|(questionsTaskList)|(downloadcheckpicture)|(downloaddatabasecheck)|(getnormal)|(queryUserNormList)|(queryUnitList)|(queryTaskOverDetail)|(queryStatisticsList)|(sendMessage)|(downloaddatabasecheckone)|(questionsTaskOne)|(queryTaskIssue)|(queryTaskIssueList)|(allocation)|(groupAllocation)|(queryTaskDetailRowCheck)|(groupAllocationList)|(websocket)).*";    //不对匹配该值的访问路径拦截（正则）
