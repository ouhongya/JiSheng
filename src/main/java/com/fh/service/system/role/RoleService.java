...
public class RoleService{
	...
	public List<Role> listAllERRolespj() throws Exception {
		return (List<Role>) dao.findForList("RoleMapper.listAllERRolespj", null);
	...
	//app列出此角色下的所有用户
	public List<PageData> listAllUByRidpj(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("RoleMapper.listAllUByRidpj", pd);
	...
	public List<PageData> listAllRolesByPIdpj(Page page)throws Exception{
	 ...
	 * app添加
	 */
	public void addpj(PageData pd) throws Exception {
		dao.findForList("RoleMapper.insertpj", pd);
	}
	 ...
	 * 通过id查找
	 */
	public PageData findObjectByIdpj(PageData pd) throws Exception {
		return (PageData)dao.findForObject("RoleMapper.findObjectByIdpj", pd);
	}
	 ...
	 * app编辑角色
	 */
	public PageData editpj(PageData pd) throws Exception {
		return (PageData)dao.findForObject("RoleMapper.editpj", pd);
	}
