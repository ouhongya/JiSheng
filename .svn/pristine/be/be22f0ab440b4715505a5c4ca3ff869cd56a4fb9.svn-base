...
<html lang="en">
	...
	<td><label onclick="seticon('/static/images/app.png');"><input name="form-field-radio" type="radio" value="icon-edit">
	<span class="lbl">&nbsp;<img src="/static/images/app.png"></span>
	</label></td>

	<td><label onclick="seticon('/static/images/list.png');"><input name="form-field-radio" type="radio" value="icon-edit">
	<span class="lbl">&nbsp;<img src="/static/images/list.png"></span>
	</label></td>

	<td><label onclick="seticon('/static/images/question.png');"><input name="form-field-radio" type="radio" value="icon-edit">
	<span class="lbl">&nbsp;<img src="/static/images/question.png"></span>
	</label></td>
	...
	<td><label onclick="seticon('/static/images/setting.png');"><input name="form-field-radio" type="radio" value="icon-edit">
	<span class="lbl">&nbsp;<img src="/static/images/setting.png"></span>
	</label></td>

	<td><label onclick="seticon('/static/images/staturd.png');"><input name="form-field-radio" type="radio" value="icon-edit">
	<span class="lbl">&nbsp;<img src="/static/images/staturd.png"></span>
	</label></td>

	<td><label onclick="seticon('/static/images/table.png');"><input name="form-field-radio" type="radio" value="icon-edit">
	<span class="lbl">&nbsp;<img src="/static/images/table.png"></span>
	</label></td>

	<td><label onclick="seticon('/static/images/Lark.png');"><input name="form-field-radio" type="radio" value="icon-edit">
	<span class="lbl">&nbsp;<img src="/static/images/Lark.png"></span>
	</label></td>
				</tr>
				<tr>
